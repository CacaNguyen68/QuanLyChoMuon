...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(), encoder.encode(signUpRequest.getPassword()), signUpRequest.getPhone(), signUpRequest.getBirthday(), signUpRequest.getOrganization(), signUpRequest.getFullName(), signUpRequest.getGender(), signUpRequest.getNote(),null);
